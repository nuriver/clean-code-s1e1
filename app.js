...
var incompleteTaskHolder=document.getElementById("incomplete-tasks-list");//ul of #incomplete-task-list
...
var createNewTaskElement=function(taskString){
  ...
  var deleteButtonImg = document.createElement("img");//delete button image
    ...
    listItem.className = 'tasks__default'
...
var editTask=function(){
    ...
    var containsClass=listItem.classList.contains("tasks__default_edit");
    ...
    listItem.classList.toggle("tasks__default_edit");
};
